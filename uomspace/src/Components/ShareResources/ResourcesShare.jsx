import ResourcesShareForm from "./ResourcesShareForm";
import {
  FaBookOpen,
} from "react-icons/fa";


const ResourcesShare = () => {
  return (
      ...
      <div className="w-8/12 bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-12 bg-[url('images/UOM.jpeg')] bg-cover bg-no-repeat bg-center">
          ...
          <div className="w-full lg:w-1/2 py-16 px-12">
              <h1 className="text-4xl text-green-600 mb-4">Share Recources</h1>
              <p className="mb-4">Fill the following form and upload your work or coursesrelated pdf here!</p>
              < ResourcesShareForm />
          </div>
        </div>
      </div>
